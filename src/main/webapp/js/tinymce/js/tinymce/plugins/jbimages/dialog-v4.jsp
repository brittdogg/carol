...
<body>
	...
	<form class="form-inline" id="upl" name="upl" action="${pageContext.request.contextPath}/image/upload" method="post" enctype="multipart/form-data" target="upload_target" onsubmit="jbImagesDialog.inProgress();">
	...
	<iframe id="upload_target" name="upload_target" src="${pageContext.request.contextPath}/image/show"></iframe>
