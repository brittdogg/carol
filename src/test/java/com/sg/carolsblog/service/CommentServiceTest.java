...
public class CommentServiceTest {
    ...
    public CommentServiceTest() {
        ...
        comServ = ctx.getBean("commentService", CommentService.class);
    ...
    public void testGetAllComments() {
        ...
        com2 = comServ.addComment(com2);
        
        List<Comment> comList = comServ.getAllComments();
    ...
    public void testGetCommentsByPost() {
        ...
        List<Comment> comList = comServ.getCommentsByPost(post1.getBlogPostId());
        assertEquals(comList.size(), 2);
    }
...
//        com1.setModifiedDate(date2);
        ...
        Comment fromDao = comServ.getCommentById(com1.getBlogPostId());
    ...
    public void testEditComment() {
        ...
        comServ.editComment(com1);
        
        Comment fromDao = comServ.getCommentById(com1.getCommentId());
    ...
    public void testDeleteComment() {
        ...
        comServ.deleteComment(com1.getCommentId());
